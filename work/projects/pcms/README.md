...
- [[Fund-Number Change Regeneration Flag]] — **active**. Splits the regeneration-required flag into two: `total_mismatch` (red, blocks journaling) vs `fund_changed` (yellow, non-blocking, needs regen+resend). [pcms#2356](https://github.com/csb-ric/pcms/issues/2356), PR [#2362](https://github.com/csb-ric/pcms/pull/2362) open.
